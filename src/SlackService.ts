...
export interface SlackServiceShape {
  ...
  readonly getConversationInfo: (
    args: ConversationsInfoArguments
  ) => Effect.Effect<ConversationsInfoResponse, SlackError>
  readonly listUsers: (args?: UsersListArguments) => Effect.Effect<UsersListResponse, SlackError>
  readonly getUserInfo: (args: UsersInfoArguments) => Effect.Effect<UsersInfoResponse, SlackError>
  ...
  readonly apiCall: <R extends WebAPICallResult = WebAPICallResult>(
    method: string,
 ...
 */
export class SlackService extends Context.Service<SlackService, SlackServiceShape>()(
  "effect-slack/SlackService"
) {
  static readonly layerNoDeps: Layer.Layer<SlackService, never, SlackClient> = Layer.effect(
    SlackService,
    Effect.gen(function* () {
  ...
  static readonly layer = SlackService.layerNoDeps

  static readonly Default: Layer.Layer<SlackService, never, SlackConfig> = SlackService.layer.pipe(
   ...
   */
  static readonly Live: Layer.Layer<SlackService, Config.ConfigError> = SlackService.Default.pipe(
